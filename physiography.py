...
def main():
    ...
    def style_function(feature):
        physiography = feature['properties'].get('Physiography', 'Unknown')
        return {
            'fillColor': COLORS.get(physiography, '#ffffff'),  # Default to white
    ...
    st_folium(m, width=700, height=500)  # Use st_folium to render the map
